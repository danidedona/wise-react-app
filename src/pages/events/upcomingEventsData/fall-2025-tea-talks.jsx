export default {
  ...
  description:
    "WiSE is collaborating with Ten One Tea to host our first Mentor-Mentee Event! Sign-up form will be released this Friday 10/17 at noon",
  imageFolder: "/events/fall-2025-tea-talks",
};
